...
public static partial class STR {
    ...
    //==========================================================================================================================================================
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string IntToBinaryString(byte   INT) =>               Convert.ToString(      INT, 2).PadLeft( 8,'0');
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string IntToBinaryString(sbyte  INT) =>               Convert.ToString(      INT, 2).PadLeft( 8,'0');
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string IntToBinaryString(short  INT) => Regex.Replace(Convert.ToString(      INT, 2).PadLeft(16,'0'), @".{8}(?!$)", @"$0_");
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string IntToBinaryString(ushort INT) => Regex.Replace(Convert.ToString(      INT, 2).PadLeft(16,'0'), @".{8}(?!$)", @"$0_");
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string IntToBinaryString(int    INT) => Regex.Replace(Convert.ToString(      INT, 2).PadLeft(32,'0'), @".{8}(?!$)", @"$0_");
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string IntToBinaryString(uint   INT) => Regex.Replace(Convert.ToString(      INT, 2).PadLeft(32,'0'), @".{8}(?!$)", @"$0_");
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string IntToBinaryString(long   INT) => Regex.Replace(Convert.ToString(      INT, 2).PadLeft(64,'0'), @".{8}(?!$)", @"$0_");
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string IntToBinaryString(ulong  INT) => Regex.Replace(Convert.ToString((long)INT, 2).PadLeft(64,'0'), @".{8}(?!$)", @"$0_");
